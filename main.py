...
allowed_channels = [1090678631489077331] if os.environ['ENVIRONMENT'] == 'development' else [1134007804244529212, 1133743935727091773, 1090678631489077333, 1114285942375718986, 1135457812982530068]
